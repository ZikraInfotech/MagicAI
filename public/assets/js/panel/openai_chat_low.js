    ...
    setTimeout(function (){
        ...
        const generate = async (ev) => {
            ...
            try {
                ...
                while (true) {
                    ...
                    for (const parsedLine of parsedLines) {
                        ...
                        if (content) {
                            ...
                            aiBubbleWrapper.querySelector( '.chat-content' ).innerHTML += content.replace(/(?:\r\n|\r|\n)/g, '<br>');
                            chatsContainer.animate( { scrollTop: chatsContainer[ 0 ].scrollHeight }, 100 );
                        }
                    }
                }
                ...
                if (signal.aborted) {
                    aiBubbleWrapper.querySelector( '.chat-content' ).innerHTML = "Request aborted. Not saved.";
                    ...
                    aiBubbleWrapper.querySelector( '.chat-content' ).innerHTML = "Error occurred while generating. Please reload the page and try again.";
                    generateBtn.disabled = false;
                    generateBtn.classList.remove( 'submitting' );
                    document.getElementById( "chat_form" ).reset();
                ...
                jQuery( ".chats-container" ).animate( { scrollTop: jQuery( ".chats-container" )[ 0 ]?.scrollHeight }, 200 );
                jQuery( "#scrollable_content" ).animate( { scrollTop: jQuery( "#scrollable_content" ).outerHeight() }, 200 );
                window.removeEventListener( 'beforeunload', onBeforePageUnload );
            }
        };
